...
const showDiscord = window.location.host.search('akashcry') > -1;
...
<template>
  <div class="bg-gray-100 dark:bg-[#3d1d1d]">
    <!-- sidebar -->
    <div
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <div
            class="collapse-title !py-0 px-4 flex items-center cursor-pointer hover:bg-gray-100 dark:hover:bg-[#382727]"
          >
            <Icon
              v-if="item?.icon?.icon"
              :icon="item?.icon?.icon"
          ...
          <div class="collapse-content">
            ...
            >
              <RouterLink
                v-if="isNavLink(el)"
                @click="sidebarShow = false"
                class="hover:bg-gray-100 dark:hover:bg-[#382727] rounded cursor-pointer px-3 py-2 flex items-center"
                :class="{
        ...
        <RouterLink
          ...
          :to="item?.to"
          @click="sidebarShow = false"
          class="cursor-pointer rounded-lg px-4 flex items-center py-2 hover:bg-gray-100 dark:hover:bg-[#382727]"
        >
          <Icon
            v-if="item?.icon?.icon"
            :icon="item?.icon?.icon"
